    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-description">
                Basic Detailes For Company Register
            </p>
            @foreach ($postdata as $item)
                
            <form class="forms-sample" action=" {{ url('edit/'.$item->company_id) }}"method="POST">
                @csrf
         ...
         <input type="hidden" name="company_id" value="{{$item->company_id}}">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" name="company_name"
                      value="{{$item->company_name}}"  placeholder="Name" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail3">Email address</label>
                    <input type="email" class="form-control" id="exampleInputEmail3" name="email"
                    value="{{$item->email}}"  placeholder="Email" required readonly>
                </div>

                <div class="form-group">
                    <label for="bank_name">State/City</label>
                    <input type="text" class="form-control" id="state" name="city" placeholder="Location"
                    value="{{$item->city}}"    required>
                    {{-- {{ Form::selectBank("city", $merchant['paymentInfo']->bank_name ?? null,["class"=>"form-control"]) }} --}}
                </div>

                <div class="form-group">
                    <label for="exampleInputCity1">Mobile</label>
                    <input type="text" class="form-control" id="exampleInputmobile" name="mobile"
                    value="{{$item->mobile}}"       placeholder="MObile No" required>
                </div>
            ...
            <p class="text-muted">
                If Update Go to the Page <a href="searchcompany" class="text-reset">Clicl Here</a>.
               </p>
        </div>
    </div>
</div>
            ...
            <div class="table-responsive">
              <table id="example" class="display expandable-table" style="width:100%">
                ...
                <tbody>
                  ...
                  @foreach ($getdataforDDl as  $company_data)
                  <tr>
                    <th scope="row"></th>
